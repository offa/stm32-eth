...
set(FLAGS_C "")
set(FLAGS_LINKER "-nostartfiles -Xlinker --gc-sections --specs=nano.specs -T mem.ld -T libs.ld -T sections.ld -L${PROJECT_SOURCE_DIR}/ldscripts -Wl,-Map,${PROJECT_NAME}.map")
